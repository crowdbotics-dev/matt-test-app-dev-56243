"""
Django settings for matt_test_app_dev_56243 project.
...
ROOT_URLCONF = 'matt_test_app_dev_56243.urls'
...
WSGI_APPLICATION = 'matt_test_app_dev_56243.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "matt_test_app_dev_56243 API",
    "DESCRIPTION": "API documentation for matt_test_app_dev_56243 App",
    "VERSION": "v1",
}
